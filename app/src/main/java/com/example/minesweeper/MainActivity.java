...
public class MainActivity extends AppCompatActivity implements OnCellClickListener {
    ...
    private TextView smiley, timer, flagsLeft, flag;
    ...
    public void cellClick(Cell cell) {
        ...
        if (mineSweeperGame.isGameOver()) {
            ...
            mineSweeperGame.getMineGrid().revealAllBombs();
            MediaPlayer music = MediaPlayer.create(MainActivity.this, R.raw.explosion);
            music.start();
        }
        ...
        if (mineSweeperGame.isGameWon()) {
            ...
            mineSweeperGame.getMineGrid().revealAllBombs();
            MediaPlayer music = MediaPlayer.create(MainActivity.this, R.raw.win);
            music.start();
        }
